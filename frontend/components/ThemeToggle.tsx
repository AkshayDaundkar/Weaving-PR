...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggle}
      className="p-2 rounded-lg border border-bg-border bg-bg-secondary text-[var(--text-primary)] hover:bg-accent hover:text-white hover:border-accent transition-colors"
